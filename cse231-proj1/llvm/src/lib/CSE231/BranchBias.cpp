...
namespace {
    struct BranchBias : public ModulePass {
        ...
        virtual bool runOnModule (Module &M) {
            ...
            branchTaken = cast<Function> (M.getOrInsertFunction("branchTaken", 
                                          Type::getVoidTy(M.getContext()), 
                                          Type::getInt8PtrTy(M.getContext()), 
                                          (Type*)0));
            branchFound = cast<Function> (M.getOrInsertFunction("foundBranch", 
                                          Type::getVoidTy(M.getContext()), 
                                          Type::getInt8PtrTy(M.getContext()), 
                                          (Type*)0));
            printFunction = cast<Function> (M.getOrInsertFunction("printStatistics", 
                                            Type::getVoidTy(M.getContext()), 
                                            (Type*)0));
